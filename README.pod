...
=head2 GENERICSPARSEARRAY_FREE(sparseArrayName)

Releases the array. This may call the free callback functions.
...
L<genericHJash|https://github.com/jddurand/c-genericHash>
